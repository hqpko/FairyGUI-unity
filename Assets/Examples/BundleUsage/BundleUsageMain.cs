...
/// </summary>
internal class BundleUsageMain : MonoBehaviour
{
    ...
    private IEnumerator LoadUIPackage()
    {
        var url = Application.streamingAssetsPath.Replace("\\", "/") + "/fairygui-examples/bundleusage.ab";
