...
namespace FairyGUI
{
    ...
    public class UIPanel : MonoBehaviour, EMRenderTarget
    {
        ...
        [SerializeField] private Vector2 cachedUISize;
        [SerializeField] private HitTestMode hitTestMode = HitTestMode.Default;
        [SerializeField] private bool setNativeChildrenOrder = false;

        [NonSerialized] private int screenSizeVer;
        [NonSerialized] private Rect uiBounds; //Track bounds even when UI is not created, edit mode
        ...
        private void HandleScreenSizeChanged()
        {
            ...
            if (container != null)
            {
                ...
                if (container.renderMode != RenderMode.WorldSpace)
                {
                    ...
                    container.scale = new Vector2(sc.unitsPerPixel * UIContentScaler.scaleFactor,
